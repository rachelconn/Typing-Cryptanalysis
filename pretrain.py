#!/usr/bin/env python
# Adapted from here: https://github.com/huggingface/transformers/tree/main/examples/pytorch/speech-pretraining
# coding=utf-8
...
def main():
    ...
    for dataset_config_name in args.dataset_config_names:
        # load dataset
    ...
    if isinstance(num_rows, dict):
        num_rows = num_rows['train']
    num_validation_samples = num_rows * args.validation_split_percentage // 100
    ...
    raw_datasets["validation"] = raw_datasets["train"]['train'].select(range(num_validation_samples))
    raw_datasets["train"] = raw_datasets["train"]['train'].select(range(num_validation_samples, num_rows))
